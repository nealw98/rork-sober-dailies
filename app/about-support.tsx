        ...
        <ScrollView contentContainerStyle={[styles.scrollContent, { paddingBottom: insets.bottom + 96 }]}>
          ...
          <View style={styles.introContainer}>
            <Text style={styles.introText}>
              I built Sober Dailies as a simple daily program with all the tools I needed in one place. Your support helps cover my costs and keeps it free for everyone.
            </Text>
          </View>
