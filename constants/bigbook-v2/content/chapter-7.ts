...
export const chapter_7: BigBookChapter = {
  ...
  paragraphs: [
    ...
    },
    {
      ...
      pageNumber: 98,
      order: 36,
      content: 'Burn the idea into the consciousness of every man that he can get well regardless of anyone.  The only condition is that he trust in God and clean house.',
    },
    {
      id: 'chapter-7-p37',
      chapterId: 'chapter-7',
    ...
    },
    {
      ...
      pageNumber: 99,
      order: 41,
      content: 'Let no alcoholic say he cannot recover unless he has his family back.  This just isn\'t so.  In some cases the wife will never come back for one reason or another.  Remind the prospect that his recovery is not dependent',
    },
    {
      id: 'chapter-7-p42',
      chapterId: 'chapter-7',
      pageNumber: 100,
      order: 42,
      content: 'upon people.  It is dependent upon his relationship with God.  We have seen men get well whose families have not returned at all.  We have seen others slip when the family came back too soon.',
    },
    {
      id: 'chapter-7-p43',
      chapterId: 'chapter-7',
    ...
    },
    {
      ...
      pageNumber: 102,
      order: 55,
      content: 'Many of us keep liquor in our homes.  We often need it to carry green recruits through a severe hangover  Some of us still serve it to our friends provided they are not alcoholic.  But some of us think we should not serve liquor to anyone.  We never argue this question.',
    },
    {
      id: 'chapter-7-p56',
      chapterId: 'chapter-7',
      pageNumber: 103,
      order: 56,
      content: 'We feel that each family, in the light of their own circumstances, ought to decide for themselves.',
    },
    {
      id: 'chapter-7-p57',
      chapterId: 'chapter-7',
