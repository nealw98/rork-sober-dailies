...
export const chapter_10: BigBookChapter = {
  ...
  paragraphs: [
    ...
    },
    {
      ...
      pageNumber: 144,
      order: 38,
      content: 'On your employee\'s return, talk with him.  Ask him if he thinks he has the answer.  If he feels free to discuss his problems with you, if he knows you understand',
    },
    {
      id: 'chapter-10-p39',
      chapterId: 'chapter-10',
      pageNumber: 145,
      order: 39,
      content: 'and will not be upset by anything he wishes to say, he will probably be off to a fast start.',
    },
    {
      id: 'chapter-10-p40',
      chapterId: 'chapter-10',
    ...
    },
    {
      ...
      pageNumber: 148,
      order: 52,
      content: 'and the fact that you went away for treatment will not be mentioned.  But if you cannot or will not stop drinking, I think you ought to resign." Your junior executive may not agree with the contents of our book.  He need not, and often should not show it to his alcoholic prospect.  But at least he will understand the problem and will no longer be misled by ordinary promises.  He will be able to take a position with such a man which is eminently fair and square.  He will have no further reason for covering up an alcoholic employee.',
    },
    {
      id: 'chapter-10-p53',
      chapterId: 'chapter-10',
      pageNumber: 148,
      order: 53,
      content: 'It boils right down to this:  No man should be fired just because he is alcoholic.  If he wants to stop, he should be afforded a real chance.  If he cannot or does not want to stop, he should be discharged.  The exceptions are few.',
    },
    {
      id: 'chapter-10-p54',
      chapterId: 'chapter-10',
