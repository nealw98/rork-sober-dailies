...
export const chapter_8: BigBookChapter = {
  ...
  paragraphs: [
    ...
    },
    {
      ...
      pageNumber: 104,
      order: 5,
      content: 'We have traveled rocky roads, there is no mistake about that. We have had long rendezvous with hurt pride, frustration, self-pity, misunderstanding and fear. These are not pleasant companions. We have been',
    },
    {
      id: 'chapter-8-p6',
      chapterId: 'chapter-8',
    ...
    },
    {
      ...
      pageNumber: 107,
      order: 19,
      content: 'Under these conditions we naturally make mistakes. Some of them rose out of ignorance of alcoholism. Sometimes we sensed dimly that we were dealing with sick men. Had we fully understood the nature of the alcoholic illness, we might have behaved differently.',
    },
    {
      id: 'chapter-8-p20',
      chapterId: 'chapter-8',
    ...
    },
    {
      ...
      pageNumber: 108,
      order: 27,
      content: 'ONE: Your husband may be only a heavy drinker.',
    },
    {
      id: 'chapter-8-p28',
      chapterId: 'chapter-8',
    ...
    },
    {
      ...
      pageNumber: 109,
      order: 30,
      content: 'THREE: This husband has gone much further than husband number two. Though once like number two',
    },
    {
      id: 'chapter-8-p31',
      chapterId: 'chapter-8',
    ...
    },
    {
      ...
      pageNumber: 115,
      order: 52,
      content: 'phone had never been invented.',
    },
    {
      id: 'chapter-8-p53',
      chapterId: 'chapter-8',
    ...
    },
    {
      ...
      pageNumber: 115,
      order: 56,
      content: 'Frequently, you have felt obliged to tell your husband\'s employer and his friends that he was sick, when as a matter of fact he was tight. Avoid answering these inquiries as much as you can. Whenever possible, let your husband explain. Your desire to protect him should not cause you to lie to people when they have a right to know where he is and what he is doing. Dis-',
    },
    {
      id: 'chapter-8-p57',
      chapterId: 'chapter-8',
      pageNumber: 116,
      order: 57,
      content: 'cuss this with him when he is sober and in good spirits. Ask him what you should do if he places you in such a position again. But be careful not to be resentful about the last time he did so.',
    },
    {
      id: 'chapter-8-p58',
      chapterId: 'chapter-8',
    ...
    },
    {
      ...
      pageNumber: 117,
      order: 61,
      content: 'thing. We urge you to try our program, for nothing will be so helpful to your husband as the radically changed attitude toward him which God will show you how to have. Go along with you husband if you possibly can.',
    },
    {
      id: 'chapter-8-p62',
      chapterId: 'chapter-8',
      pageNumber: 117,
      order: 62,
      content: 'If you and your husband find a solution for the pressing problem of drink you are, of course, going to very happy. But all problems will not be solved at once. Seed has started to sprout in a new soil, but growth has only begun. In spite of your new-found happiness, there will be ups and downs. Many of the old problems will still be with you. This is as it should be.',
    },
    {
      id: 'chapter-8-p63',
      chapterId: 'chapter-8',
    ...
    },
    {
      ...
      pageNumber: 120,
      order: 75,
      content: 'We never, never try to arrange a man\'s life so as to shield him from temptation. The slightest disposition on your part to guide his appointment or his affairs so he will not be tempted will be noticed. Make him feel absolutely free to come and go as he likes. This is important. If he gets drunk, don\'t blame yourself. God has either removed your husband\'s liquor problem or He has not. If not, it had better be found out right away. Then you and your husband can get right down to fundamentals. If a repetition is to be prevented, place the problem, along with everything else, in God\'s hands.',
    },
    {
      id: 'chapter-8-p76',
      chapterId: 'chapter-8',
    ...
    },
    {
      ...
      pageNumber: 121,
      order: 79,
      content: 'If there is no Al-Anon listing in your local telephone book, you may obtain further information on Al-Anon Family Groups by writing to its World Service Office: Box 862, Midtown Station, New York, NY 10018-0862.',
    }
  ],
};
