...
export const foreword_second: BigBookChapter = {
  ...
  paragraphs: [
    ...
    },
    {
      ...
      pageNumber: 15,
      order: 5,
      content: '--- *Page xvi* --- experience, following a meeting with an alcoholic friend who had been in contact with the Oxford Groups of that day. He had also been greatly helped by the late Dr. William D. Silkworth, a New York specialist in alcoholism who is now accounted no less than a medical saint by A.A. members, and whose story of the early days of our Society appears in the next pages. From this doctor, the broker had learned the grave nature of alcoholism. Though he could not accept all the tenets of the Oxford Groups, he was convinced of the need for moral inventory, confession of personality defects, restitution to those harmed, helpfulness to others, and the necessity of belief in and dependance upon God.',
    },
    {
    ...
    },
    {
      ...
      pageNumber: 15,
      order: 11,
      content: '--- *Page xviii* --- to convince the membership that a new light had entered the dark world of the alcoholic.',
    },
    {
    ...
    },
    {
      ...
      pageNumber: 15,
      order: 17,
      content: '--- *Page xx* --- prestige? Would there be schisms which would split A.A. apart? Soon A.A. was beset by these very problems on every side and in every group. But out of this frightening and at first disrupting experience the conviction grew that A.A.\'s had to hang together or die separately. We had to unify our Fellowship or pass off the scene.',
    },
    {
