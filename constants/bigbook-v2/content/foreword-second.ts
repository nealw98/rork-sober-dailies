...
export const foreword_second: BigBookChapter = {
  ...
  paragraphs: [
    ...
    },
    {
      ...
      pageNumber: 16,
      order: 7,
      content: 'This physician had repeatedly tried spiritual means to resolve his alcoholic dilemma but had failed. But when the broker gave him Dr. Silkworth\'s description',
    },
    {
    ...
    },
    {
      ...
      pageNumber: 18,
      order: 11,
      content: 'to convince the membership that a new light had entered the dark world of the alcoholic.',
    },
    {
    ...
    },
    {
      ...
      pageNumber: 20,
      order: 19,
      content: 'This was the substance of A.A.\'s Twelve Traditions, which are stated in full on page 564 of this book. Though none of these principles had the force of rules or laws, they had become so widely accepted by 1950 that they were confirmed by our first International Conference held at Cleveland. Today the remarkable unity of A.A. is one of the greatest assets that our Society has.',
    },
    {
