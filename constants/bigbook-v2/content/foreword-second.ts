 ...
 *
 * Pages xv-xxi (15-21). Text and page breaks transcribed 2026-07-31 from
 * A.A. World Services' own 4th-edition PDF of this foreword (aa.org). The
 * previous transcription had dropped a clause, carried third-edition
 * figures, and ran a page longer than the chapter does.
 */

export const foreword_second: BigBookChapter = {
  id: 'foreword-second',
  title: 'Foreword to Second Edition',
  pageRange: [15, 21],
  paragraphs: [
    {
      id: 'foreword-second-p1',
      chapterId: 'foreword-second',
      pageNumber: 15,
      order: 1,
      content: 'Figures given in this foreword describe the Fellowship as it was in 1955.',
      isItalic: true,
    },
    {
    ...
    {
      id: 'foreword-second-p15',
      chapterId: 'foreword-second',
      pageNumber: 18,
      order: 15,
      content: 'Our Society then entered a fearsome and exciting adolescent period. The test that it faced was this: Could these large numbers of erstwhile erratic alcoholics successfully meet and work together? Would there be quarrels over membership, leadership, and money? Would there be strivings for power and',
    },
    {
      ...
      pageNumber: 19,
      order: 16,
      content: 'prestige? Would there be schisms which would split A.A. apart? Soon A.A. was beset by these very problems on every side and in every group. But out of this frightening and at first disrupting experience the conviction grew that A.A.\'s had to hang together or die separately. We had to unify our Fellowship or pass off the scene.',
    },
    {
      id: 'foreword-second-p17',
      chapterId: 'foreword-second',
      pageNumber: 19,
      order: 17,
      content: 'As we discovered the principles by which the individual alcoholic could live, so we had to evolve principles by which the A.A. groups and A.A. as a whole could survive and function effectively. It was thought that no alcoholic man or woman could be excluded from our Society; that our leaders might serve but never govern; that each group was to be autonomous and there was to be no professional class of therapy. There were to be no fees or dues; our expenses were to be met by our own voluntary contributions. There was to be the least possible organization, even in our service centers. Our public relations were to be based upon attraction rather than promotion. It was decided that all members ought to be anonymous at the level of press, radio, TV and films. And in no circumstances should we give endorsements, make alliances, or enter public controversies.',
    },
    {
      id: 'foreword-second-p18',
      chapterId: 'foreword-second',
      pageNumber: 19,
      order: 18,
      content: 'This was the substance of A.A.\'s Twelve Traditions, which are stated in full on page 561 of this book. Though none of these principles had the force of rules or laws, they had become so widely accepted by 1950 that they were confirmed by our first International Conference held at Cleveland. Today the remarkable unity of A.A. is one of the greatest assets that our Society has.',
    },
    {
      id: 'foreword-second-p19',
      chapterId: 'foreword-second',
      pageNumber: 19,
      order: 19,
      content: 'While the internal difficulties of our adolescent',
    },
    {
      id: 'foreword-second-p20',
      chapterId: 'foreword-second',
      pageNumber: 20,
      order: 20,
      content: 'period were being ironed out, public acceptance of A.A. grew by leaps and bounds. For this there were two principal reasons: the large numbers of recoveries, and reunited homes. These made their impressions everywhere. Of alcoholics who came to A.A. and really tried, 50% got sober at once and remained that way; 25% sobered up after some relapses, and among the remainder, those who stayed on with A.A. showed improvement. Other thousands came to a few A.A. meetings and at first decided they didn\'t want the program. But great numbers of these—about two out of three—began to return as time passed.',
    },
    {
      id: 'foreword-second-p21',
      chapterId: 'foreword-second',
      pageNumber: 20,
      order: 21,
      content: 'Another reason for the wide acceptance of A.A. was the ministration of friends—friends in medicine, religion, and the press, together with innumerable others who became our able and persistent advocates. Without such support, A.A. could have made only the slowest progress. Some of the recommendations of A.A.\'s early medical and religious friends will be found further on in this book.',
    },
    {
      id: 'foreword-second-p22',
      chapterId: 'foreword-second',
      pageNumber: 20,
      order: 22,
      content: 'Alcoholics Anonymous is not a religious organization. Neither does A.A. take any particular medical point of view, though we cooperate widely with the men of medicine as well as with the men of religion.',
    },
    {
      id: 'foreword-second-p23',
      chapterId: 'foreword-second',
      pageNumber: 20,
      order: 23,
      content: 'Alcohol being no respecter of persons, we are an accurate cross section of America, and in distant lands, the same democratic evening-up process is now going on. By personal religious affiliation, we include Catholics, Protestants, Jews, Hindus, and a sprinkling of Moslems and Buddhists. More than 15% of us are women.',
    },
    {
      id: 'foreword-second-p24',
      chapterId: 'foreword-second',
      pageNumber: 20,
      order: 24,
      content: 'At present, our membership is pyramiding at the rate of about twenty per cent a year. So far, upon the',
    },
    {
