...
export const chapter_6: BigBookChapter = {
  id: 'chapter-6',
  title: 'Into Action',
  chapterNumber: 6,
  pageRange: [72, 88],
  paragraphs: [
    ...
    },
    {
      ...
      pageNumber: 73,
      order: 3,
      content: 'invariably they got drunk.  Having persevered with the rest of the program, they wondered why they fell.  We think the reason is that they never completed their housecleaning.  They took inventory all right, but hung on to some of the worst items in stock.  They only _thought_ they had lost their egoism and fear; they only _thought_ they had humbled themselves.  But they had not learned enough of humility, fearlessness and honesty, in the sense we find it necessary, until they told someone else _all_ their life story.',
    },
    {
      id: 'chapter-6-p4',
      chapterId: 'chapter-6',
      pageNumber: 73,
      order: 4,
      content: 'More than most people, the alcoholic leads a double life.  He is very much the actor.  To the outer world he presents his stage character.  This is the one he likes his fellows to see.  He wants to enjoy a certain reputation, but knows in his heart he doesn\'t deserve it.',
    },
    {
      id: 'chapter-6-p5',
      chapterId: 'chapter-6',
    ...
    },
    {
      ...
      pageNumber: 73,
      order: 7,
      content: 'We must be entirely honest with somebody if we',
    },
    {
      id: 'chapter-6-p8',
      chapterId: 'chapter-6',
    ...
    },
    {
      ...
      pageNumber: 74,
      order: 9,
      content: 'If we cannot or would rather not do this, we search our acquaintance for a close-mouthed, understanding friend.  Perhaps our doctor or psychologist will be the person.  It may be one of our own family, but we cannot disclose anything to our wives or our parents which will hurt them and make them unhappy.  We have no right to save our own skin at another person\'s expense.  Such parts of our story we tell to someone who will understand, yet be unaffected.  The rule is we must be hard on ourself, but always considerate of others.',
    },
    {
      id: 'chapter-6-p10',
      chapterId: 'chapter-6',
    ...
    },
    {
      ...
      pageNumber: 75,
      order: 11,
      content: 'that he will not try to change our plan.  But we must not use this as a mere excuse to postpone.',
    },
    {
      id: 'chapter-6-p12',
      chapterId: 'chapter-6',
    ...
    },
    {
      ...
      pageNumber: 75,
      order: 13,
      content: 'We pocket our pride and go to it, illuminating every twist of character, every dark cranny of the past.  Once we have taken this step, withholding nothing, we are delighted.  We can look the world in the eye.  We can be alone at perfect peace and ease.  Our fears fall from us.  We begin to feel the nearness of our Creator.  We may have had certain spiritual beliefs, but now we begin to have a spiritual experience.  The feeling that the drink problem has disappeared will often come strongly.  We feel we are on the Broad Highway, walking hand in hand with the Spirit of the Universe.',
    },
    {
      id: 'chapter-6-p14',
      chapterId: 'chapter-6',
    ...
    },
    {
      ...
      pageNumber: 77,
      order: 21,
      content: 'Under no condition do we criticize such a person or argue.  Simply we tell him that we will never get over drinking until we have done our utmost to straighten out the past.  We are there to sweep off our side of the street, realizing that nothing worth while',
    },
    {
      id: 'chapter-6-p22',
      chapterId: 'chapter-6',
      pageNumber: 78,
      order: 22,
      content: 'can be accomplished until we do so, never trying to tell him what he should do.  His faults are not discussed.  We stick to our own.  If our manner is calm, frank, and open, we will be gratified with the result.',
    },
    {
      id: 'chapter-6-p23',
      chapterId: 'chapter-6',
    ...
    },
    {
      ...
      pageNumber: 79,
      order: 26,
      content: 'Maybe we are divorced, and have remarried but haven\'t kept up the alimony to number one.  She is indignant about it, and has a warrant out for our arrest.  That\'s a common form of trouble too.',
    },
    {
      id: 'chapter-6-p27',
      chapterId: 'chapter-6',
      pageNumber: 79,
      order: 27,
      content: 'Although these reparations take innumerable forms, there are some general principles which we find guiding.  Reminding ourselves that we have decided to go to any lengths to find a spiritual experience, we ask that we be given strength and direction to do the right thing, no matter what the personal consequences may be.  We may lose our position or reputation or face jail, but we are willing.  We have to be.  We must not shrink at anything.',
    },
    {
      id: 'chapter-6-p28',
      chapterId: 'chapter-6',
    ...
    },
    {
      ...
      pageNumber: 80,
      order: 29,
      content: 'Before taking drastic action which might implicate other people we secure their consent.  If we have obtained permission, have consulted with others, asked God to help and the drastic step is indicated we must not shrink.',
    },
    {
      id: 'chapter-6-p30',
      chapterId: 'chapter-6',
    ...
    },
    {
      ...
      pageNumber: 80,
      order: 33,
      content: 'The chances are that we have domestic troubles.  Perhaps we are mixed up with women in a fashion we',
    },
    {
      id: 'chapter-6-p34',
      chapterId: 'chapter-6',
    ...
    },
    {
      ...
      pageNumber: 81,
      order: 36,
      content: 'Our design for living is not a one-way street.  It is as good for the wife as for the husband.  If we can',
    },
    {
      id: 'chapter-6-p37',
      chapterId: 'chapter-6',
      pageNumber: 82,
      order: 37,
      content: 'forget, so can she.  It is better, however, that one does not needlessly name a person upon whom she can vent jealousy.',
    },
    {
      id: 'chapter-6-p38',
      chapterId: 'chapter-6',
    ...
    },
    {
      ...
      pageNumber: 83,
      order: 41,
      content: 'Yes, there is a long period of reconstruction ahead.  We must take the lead.  A remorseful mumbling that we are sorry won\'t fill the bill at all.  We ought to sit down with the family and frankly analyze the past as we now see it, being very careful not to criticize them.  Their defects may be glaring, but the chances are that our own actions are partly responsible.  So we clean house with the family, asking each morning in meditation that our Creator show us the way of patience, tolerance, kindliness and love.',
    },
    {
      id: 'chapter-6-p42',
      chapterId: 'chapter-6',
    ...
    },
    {
      ...
      pageNumber: 83,
      order: 44,
      content: 'If we are painstaking about this phase of our development, we will be amazed before we are half way through.  We are going to know a new freedom and a new happiness.  We will not regret the past nor wish to shut the door on it.  We will comprehend the',
    },
    {
      id: 'chapter-6-p45',
      chapterId: 'chapter-6',
    ...
    },
    {
      ...
      pageNumber: 85,
      order: 49,
      content: 'react sanely and normally, and we will find that this has happened automatically.  We will see that our new attitude toward liquor has been given us without any thought or effort on our part.  It just comes!  That is the miracle of it.  We are not fighting it, neither are we avoiding temptation.  We feel as though we had been placed in a position of neutrality - safe and protected.  We have not even sworn off.  Instead, the problem has been removed.  It does not exist for us.  We are neither cocky nor are we afraid.  That is our experience.  That is how we react so long as we keep in fit spiritual condition.',
    },
    {
      id: 'chapter-6-p50',
      chapterId: 'chapter-6',
      pageNumber: 85,
      order: 50,
      content: 'It is easy to let up on the spiritual program of action and rest on our laurels.  We are headed for trouble if we do, for alcohol is a subtle foe.  We are not cured of alcoholism.  What we really have is a daily reprieve contingent on the maintenance of our spiritual condition.  Every day is a day when we must carry the vision of God\'s will into all of our activities. "How can I best serve Thee - Thy will (not mine) be done." These are thoughts which must go with us constantly.  We can exercise our will power along this line all we wish.  It is the proper use of the will.',
    },
    {
      id: 'chapter-6-p51',
      chapterId: 'chapter-6',
      pageNumber: 85,
      order: 51,
      content: 'Much has already been said about receiving strength, inspiration, and direction from Him who has all knowledge and power.  If we have carefully followed directions, we have begun to sense the flow of His Spirit into us.  To some extent we have become God-conscious.  We have begun to develop this vital sixth sense.  But we must go further and that means more action.',
    },
    {
      id: 'chapter-6-p52',
      chapterId: 'chapter-6',
    ...
    },
    {
      ...
      pageNumber: 86,
      order: 53,
      content: 'than we are using it constantly.  It works, if we have the proper attitude and work at it.  It would be easy to be vague about this matter.  Yet, we believe we can make some definite and valuable suggestions.',
    },
    {
      id: 'chapter-6-p54',
      chapterId: 'chapter-6',
    ...
    },
    {
      ...
      pageNumber: 87,
      order: 60,
      content: 'As we go through the day we pause, when agitated or doubtful, and ask for the right thought or action.  We constantly remind ourselves we are no longer',
    },
    {
      id: 'chapter-6-p61',
      chapterId: 'chapter-6',
    ...
    },
    {
      ...
      pageNumber: 88,
      order: 63,
      content: 'We alcoholics are undisciplined.  So we let God discipline us in the simple way we have just outlined.',
    },
    {
      id: 'chapter-6-p64',
      chapterId: 'chapter-6',
