...
// Corrected scraping script with proper page ranges
async function scrapeCorrectedAnonymousPress() {
  const sections = [
    {
      id: 'doctors-opinion',
    ...
    },
    {
      ...
      startPage: '123',
      pages: ['123', '124', '125', '126', '127', '128', '129', '130', '131', '132', '133', '134', '135'],
      type: 'multi-page'
    },
    {
      id: 'chapter-9',
      title: 'Chapter 9 - The Family Afterward',
      startPage: '136',  // This was wrong in previous version
      pages: ['136', '137', '138', '139', '140', '141', '142', '143', '144', '145', '146', '147', '148', '149', '150'],
      type: 'multi-page'
    },
    {
      id: 'chapter-10',
      title: 'Chapter 10 - To Employers',
      startPage: '151',  // Corrected from 159
    ...
    },
    {
      ...
      startPage: '165',  // Corrected from 171
      pages: ['165', '166', '167', '168', '169', '170', '171', '172', '173', '174', '175', '176', '177', '178', '179', '180', '181', '182', '183', '184'],
      type: 'multi-page'
    },
    {
  ...
  console.log(`Starting corrected 1st edition scraping...`);
...
// Run the corrected scraper
scrapeCorrectedAnonymousPress()
  .then(() => {
    console.log('\n🎉 Corrected 1st edition scraping finished!');
    console.log('Check the 1st-edition-corrected folder for all results.');
    console.log('\nFiles created:');
  ...
  .catch(error => {
    console.error('\n✗ Corrected scraping failed:', error);
  });
