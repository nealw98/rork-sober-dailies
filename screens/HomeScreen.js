  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity style={styles.card} onPress={() => handleButtonPress('Gratitude')}>
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity style={styles.card} onPress={() => console.log('Evening Review - Coming Soon')}>
