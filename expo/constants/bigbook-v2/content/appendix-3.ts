...
export const appendix_3: BigBookChapter = {
  id: 'appendix-3',
  ...
  paragraphs: [
    ...
    },
    {
      ...
      pageNumber: 571,
      order: 3,
      content: 'Dr. G. Kirby Collier, psychiatrist: "I have felt that A.A. is a group unto themselves and their best results can be had under their own guidance, as a result of their philosophy. Any therapeutic or philosophic procedure which can prove a recovery rate of 50% to 60% must merit our consideration."',
    },
    {
      id: 'appendix-3-p4',
      chapterId: 'appendix-3',
    ...
    },
    {
      ...
      pageNumber: 571,
      order: 8,
      content: 'The American Psychiatric Association requested, in 1949, that a paper he prepared by one of the older members of Alcoholics Anonymous to be read at the Association\'s annual meeting of that year. This was done, and the paper was printed in the American Journal of Psychiatry for November, 1949.',
    },
    {
      id: 'appendix-3-p9',
      chapterId: 'appendix-3',
      pageNumber: 571,
      order: 9,
      content: '(This address is now available in pamphlet form at nominal cost through most A.A. groups or from Box 459, Grand Central Station, New York, NY 10163, under the title "Three Talks to Medical Societies by Bill W."--formerly called "Bill on Alcoholism" and earlier "Alcoholism the Illness.")',
    }
  ],
};
