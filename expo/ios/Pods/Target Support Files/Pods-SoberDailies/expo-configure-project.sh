...
with_node \
  ...
  --target "/Users/nealwagner/Projects/rork-sober-dailies/expo/ios/Pods/Target Support Files/Pods-SoberDailies/ExpoModulesProvider.swift" \
  --entitlement "/Users/nealwagner/Projects/rork-sober-dailies/expo/ios/SoberDailies/SoberDailies.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-clipboard" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-eas-client" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-localization" "expo-location" "expo-router" "expo-secure-store" "expo-splash-screen" "expo-sqlite" "expo-store-review" "expo-symbols" "expo-system-ui" "expo-updates" "expo-web-browser"
